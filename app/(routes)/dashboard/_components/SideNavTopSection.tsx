  ...
  <PopoverContent className='ml-7 p-4'>
    ...
    <div>
        {teamList?.map((team,index)=>(
            <h2 key={index}
            className={`p-2 hover:bg-blue-500 hover:text-white rounded-lg mb-1 
            cursor-pointer
    ...
    <div>
        {menu.map((item, index)=>(
            <h2 key={index} className='flex gap-2 items-center p-2
            hover:bg-gray-100 rounded-lg cursor-pointer text-sm'
    ...
    <Separator className='mt-2 bg-slate-100'/>
    {/* User Info Section*/}
    {user&& <div className='mt-2 flec gap-2 items-center'>
